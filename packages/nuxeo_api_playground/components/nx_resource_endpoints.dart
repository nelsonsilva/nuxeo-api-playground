...
class NxParameterValue extends ChangeNotifier {
...
class ResourceEndpoints extends Module with ChangeNotifier  {
  ...
  @reflectable @observable String get op => __$op; String __$op; @reflectable set op(String value) { __$op = notifyPropertyChange(#op, __$op, value); }
...
class NXResourceEndpoints extends NXModule with SemanticUI, SearchFilter, ChangeNotifier {
  ...
  @reflectable @observable swagger.Resource get endpoint => __$endpoint; swagger.Resource __$endpoint; @reflectable set endpoint(swagger.Resource value) { __$endpoint = notifyPropertyChange(#endpoint, __$endpoint, value); }
  /// The current operation.
  @reflectable @observable swagger.Operation get operation => __$operation; swagger.Operation __$operation; @reflectable set operation(swagger.Operation value) { __$operation = notifyPropertyChange(#operation, __$operation, value); }
  ...
  @reflectable @observable nuxeo.Request get request => __$request; nuxeo.Request __$request; @reflectable set request(nuxeo.Request value) { __$request = notifyPropertyChange(#request, __$request, value); }
