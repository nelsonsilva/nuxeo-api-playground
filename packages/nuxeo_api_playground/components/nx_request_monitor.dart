...
class NXRequestMonitor extends NXElement with ChangeNotifier  {

  @reflectable @published nuxeo.BaseRequest get request => __$request; nuxeo.BaseRequest __$request; @reflectable set request(nuxeo.BaseRequest value) { __$request = notifyPropertyChange(#request, __$request, value); }
  @reflectable @published dynamic get response => __$response; dynamic __$response; @reflectable set response(dynamic value) { __$response = notifyPropertyChange(#response, __$response, value); }

  @reflectable @observable dynamic get body => __$body; dynamic __$body; @reflectable set body(dynamic value) { __$body = notifyPropertyChange(#body, __$body, value); }
  @reflectable @observable String get contentType => __$contentType; String __$contentType; @reflectable set contentType(String value) { __$contentType = notifyPropertyChange(#contentType, __$contentType, value); }

  /// A list of Blobs for downloading the response.
  final List downloads = toObservable([]);

  @reflectable @observable String get currentTab => __$currentTab; String __$currentTab = "response"; @reflectable set currentTab(String value) { __$currentTab = notifyPropertyChange(#currentTab, __$currentTab, value); }
