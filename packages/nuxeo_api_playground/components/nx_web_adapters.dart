...
class NXWebAdapters extends NXElement with SemanticUI, ChangeNotifier {
  ...
  /// The current adapter.
  @reflectable @published NxWebAdapter get adapter => __$adapter; NxWebAdapter __$adapter; @reflectable set adapter(NxWebAdapter value) { __$adapter = notifyPropertyChange(#adapter, __$adapter, value); }
