...
class NXBatchReference extends NXElement with ChangeNotifier  {
  ...
  @reflectable @published NXBatch get selected => __$selected; NXBatch __$selected; @reflectable set selected(NXBatch value) { __$selected = notifyPropertyChange(#selected, __$selected, value); }
