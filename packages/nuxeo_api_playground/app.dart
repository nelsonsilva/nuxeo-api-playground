...
class NXSandboxApp extends PolymerElement with ChangeNotifier  {

  /// The ID of a [NXConnection] element
  @reflectable @published String get connectionId => __$connectionId; String __$connectionId; @reflectable set connectionId(String value) { __$connectionId = notifyPropertyChange(#connectionId, __$connectionId, value); }

  /// The resolved [NXConnection]
  @reflectable @observable NXConnection get connection => __$connection; NXConnection __$connection; @reflectable set connection(NXConnection value) { __$connection = notifyPropertyChange(#connection, __$connection, value); }
  ...
  /// The current module
  @reflectable @observable Module get module => __$module; Module __$module = null; @reflectable set module(Module value) { __$module = notifyPropertyChange(#module, __$module, value); }
